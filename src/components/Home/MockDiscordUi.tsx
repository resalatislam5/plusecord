  ...
  return (
    <div className="flex min-h-[800px] w-full max-w-[1200px] bg-discord-background text-white rounded-lg overflow-hidden shadow-xl">
      ...
      <div className="hidden sm:flex w-[72px] bg-[#202225] py-3 flex-col items-center">
        ...
        <div className="group size-12 mt-auto bg-discord-background rounded-3xl flex items-center justify-center mb-3 hover:rounded-xl transition-all duration-200 hover:bg-discord-brand-color">
        ...
        <div className="flex-1 overflow-y-auto pt-4">
          ...
          <div className="px-2 mb-4">
            ...
            <div className="flex items-center px-2 py-1.5 rounded bg-[#393c43] text-white cursor-pointer">
              <Image
                src={"/images/brand_logo_2.avif"}
                alt="brand images"
                width={32}
                height={32}
                className="object-cover rounded-full mr-3"
              />
              <span className="font-medium">PluseCord</span>
            </div>
            <div className="my-1 space-y-px ">
              {[...Array(4)].map((_, i) => (
                ...
                >
                  <div className="size-8 rounded-full bg-discord-background mr-2" />
          ...
          <div className="flex items-center">
            <div className="relative">
              <Image
                ...
                className="object-cover rounded-full mr-3"
              />
              <div className="absolute bottom-0 right-3 size-3 bg-green-500 rounded-full border-2 border-[#36383f]" />
            </div>
            <p className="font-semibold text-white">PluseCord</p>
          </div>
